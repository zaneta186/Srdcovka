      ...
      <div class="happiness main">
        ...
        <div class="happiness__advice">
            ...
            <div class="happiness__advice__item second">
                ...
                <div class="happiness__advice__item--wrapper">
                <p class="happiness__advice__text--item" :class="{show: second, hide: !second}">Záleží také na tom, za co peníze utratíš. Nové auto tvou křivku štěstí vystřelí nahoru jen na zlomek okamžiku. Nic totiž nestárne tak rychle jako nová věc. Lepší strategií je investovat do zážitků. Sklenka červeného, skok padákem, <em class="happiness__advice__item--em">dobrovolnictví</em>? Čím pomíjivější investice, tím intenzivnější prožitek. Dovolená je nakonec krásná právě kvůli tomu, že nevyhnutelně skončí. K zážitkům se navíc můžeš vracet ve svých vzpomínkách a pocit štěstí si tak zpětně navodit.</p>
                </div>
            </div>
...
export default {
    ...
    methods: {
      ...
      // nevím, jestli tady ta šílenost jde udělat elegantněji (asi jo), ale nepřišla jsem na to, jak to jinak sladit s responzivitou, kdy na mobilu jsou vidět pořád všechny tři položky a na desktopu jen ta s aktivní třídou dle kliknutí)
...
.happiness__heading--gradient {
  background: linear-gradient(#a3333d, #ef6f6c);
}

.happiness__heading p, .happiness__perex {
  color: #00728f;
}

.happiness__advice, .happiness__perex {
    margin: 0 10% 0 10%;
    color: #291F1E;
    font-size: 110%;
    font-weight: 600;
...
.happiness__advice__item--em {
  color: #a3333d;
  font-weight: 900;
  font-style: normal;
}

.happiness__advice__item--digit {
    padding: 2rem;
    width: 4rem;
    height: 4rem;
    text-align: center;
    ...
    align-items: center;
    border-radius: 50%;
    background: linear-gradient(#00728f, #003f4e);
    margin: 1em 0 1em 0;
    color: whitesmoke;
    font-weight: 900;
}

.happiness__perex div {
  display: none;
}
...
@media (min-width: 600px) {
  ...
  .happiness__perex div:hover {
    cursor: pointer;
    background: linear-gradient(#003f4e,#00728f);
  }
